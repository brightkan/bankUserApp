...
class JessApproval:
    ...
    def perform_request(self):
        ...
        self.reqData = """<transaction>
                            ...
                            <rule2Rank>{}</rule2Rank>
                            <rule3Rank>{}</rule3Rank>
                          </transaction>""".format(self.amount,int(self.limit),self.different,int(self.numOfTrans),jess_settings.no_of_transactions_limit,jess_settings.rule_one_rank,jess_settings.rule_two_rank,jess_settings.rule_three_rank)
